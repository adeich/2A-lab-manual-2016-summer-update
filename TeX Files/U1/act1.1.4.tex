\note{Brief Overview}{
	...
	\subsubsection*{If you run out of time to complete \DL{} Activities}
		...
		In general, for any unfinished activities from the previous \DLM (which should have been assigned as an \FNT{}), give a brief summary (\textless \unit[5]{min}) at the beginning of the current \DLM{} and sum up the main points for them. Don't spend time in \DL{} as you normally would having the students discuss and explain.
