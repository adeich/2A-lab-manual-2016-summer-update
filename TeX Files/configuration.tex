...
%%%%  For a digital instructors manual %%%%%
	\togglefalse{print}	
	\toggletrue{instructor}
...
%%%%  For a printed instructors manual - odd pages (instructor notes part) %%%%%
	\toggletrue{print}	
	\toggletrue{instructor}
	\toggletrue{student_and_instructor_on_separate_pages}
...
%%%%  For a digital student manual %%%%%
	\togglefalse{print}	
	\togglefalse{instructor}
	\togglefalse{student_and_instructor_on_separate_pages}


%%%% COPY THE CONFIGURATION YOU WANT BELOW THIS LINE %%%%%%%%%%
	\togglefalse{print}	
	\togglefalse{instructor}
	\toggletrue{student_and_instructor_on_separate_pages}
