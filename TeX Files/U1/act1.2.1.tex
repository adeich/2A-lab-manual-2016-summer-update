...
\begin{enumerate}
	...
	\item Rewrite the equation expressing energy conservation for process (b) in \ref{fnt1.1.3-2}, using the expressions for $\Delta E_\text{thermal}$ and $\Delta E_\text{bond}$ that were introduced in this activity in terms of $C$ and $H$. Then substitute all known values for each variable in your expression.
