% edit configuration.tex to set thes toggles that affect the format of the compiled document
...
% edit configuration.tex to set these toggles
\newtoggle{instructor}
...
\iftoggle{instructor}
	...
	{\iftoggle{student_and_instructor_on_separate_pages}{\setcounter{tocdepth}{3}}{\setcounter{tocdepth}{1}}}	% Set to 0 or 1 for Student Edition unless it is the student side of instructor edition
...
\newmdenv[						
	...
	linewidth=\iftoggle{student_and_instructor_on_separate_pages}{\iftoggle{instructor}{0pt,}{1.5pt,}}{1.5pt,}
	]
	{fntbox}
\newenvironment{FNTenv}
	{\begin{fntbox}
		...
		\iftoggle{student_and_instructor_on_separate_pages}{\iftoggle{instructor}{\color{white}}{}}{}	
	}
	{\end{fntbox}}
...
\thispagestyle{empty}
 ...
 \newcommand{\interlude}[1]{ % for inserting one page
	\iftoggle{instructor} 
		...
		{
		\iftoggle{student_and_instructor_on_separate_pages}{
			\color{white}\begin{myinterlude} \begin{notes} #1\end{notes} \end{myinterlude}\color{black}
		}
		}
	}
