...
% testxxx}   
    	For any unfinished activities from the previous \DLM{} (which should have been assigned as an \FNT), give a brief summary (\textless 5 mins.) at the beginning of the current \DL{} and sum up the main points for them. Don't spend time in \DL{} as you normally would having the students discuss and explain.
