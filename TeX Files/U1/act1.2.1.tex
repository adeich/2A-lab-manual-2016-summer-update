...
\noindent Your instructor will give you one or two minutes to discuss each of the following in the following Parts~\hyperref[1.2.1A]{\ref*{1.2.1A}} and \ref{1.2.1B} in your Small Groups. Quickly come to a consensus and put your response on the board. Each question will be followed by a brief \textbf{Whole Class Discussion}.
...
\begin{enumerate}
	...
	\item If $\Delta H$ were given (similarly to the specific heat $C_p$) as $H_p$ in units of Joules per Kilogram (\unitfrac[]{J}{kg}) or units of Joules per Mole (\unitfrac[]{J}{mol}), how would the equation, $Q = \Delta H$, change?
	\label{1.2.1B3}
	...
	\item Rewrite the equation expressing energy conservation for process (b) in \ref{FNT1.1.3-2}, using the expressions for $\Delta E_\text{thermal}$ and $\Delta E_\text{bond}$ that were introduced in this activity in terms of $C_p$ and $H_p$. Then substitute all known values for each variable in your expression.
